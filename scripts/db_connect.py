...
if __name__ == '__main__':
    paths = {'book': '../knowledge/books.json', 'movie': '../knowledge/movies.json', 'person': '../knowledge/people.json', 'attend_in': '../knowledge/principals.json'}
    ...
    try:
        ...
        output = mongo.find_data('adaption', {'from.tid':'375802.Ender_s_Game'}, {'_id':0, 'from':1, 'tid':1})
        output = list(output)
        print(output)
    finally:
        mongo.close_database(paths.keys())